...
test('Visits to a non-page will be redirected to the index.', (assert) => {
...
test('Using a non-center will default the map to Chicago.', (assert) => {
...
test('Attempting to query with startDate after endDate returns to index and issues an error.', (assert) => {
...
test('Attempting to query with invalid startDate and endDate returns to index and issues an error.', (assert) => {
...
test('Attempting to query with invalid JSON returns to index and issues an error.', (assert) => {
...
test('Attempting to query without a geoJSON returns to index and issues an error.', (assert) => {
  visit('/discover/aggregate');
  andThen(() => {
    assert.equal(currentRouteName(), 'discover.index', 'The page returns to index.');
    visit('/discover');
