 ...
 * this function returns an array of "breaks"
 * where each element is the exclusive lower bound of a class.
 *
 * Example: given a result array of [0, 3, 5, 7],
 * a value of 4 is in the (3, 5] class
 * and a value of 7 is in the (5, 7] class.
 *
 * @param data
 * @param n_classes
 * @returns {*}
