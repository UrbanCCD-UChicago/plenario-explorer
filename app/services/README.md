# Plenar.io API Adapter Documentation
...
>**TODO: finalize the formatting for this. Possibly dynamically generate, but that might be too much overhead for this**

#### `plenario-api.fetch`
##### `plenario-api.fetch.core`
###### `plenario-api.fetch.core.metadata`
**`plenario-api.fetch.core.metadata.events`**`(datasetNames, startDate, endDate, withinArea, useSimpleBbox)`
...
- **`dateAdded`** <small>[ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) date or datetime</small>
- **`oldest`** <small>[ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) date or datetime</small>
- **`newest`** <small>[ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) date or datetime</small>
- **`lastUpdate`** <small>[ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) date or datetime</small>
