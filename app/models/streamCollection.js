...
/**
 * Needs to:
 * - take a node id and list of observed properties
 * - instantiate a mapping from observed property IDs to Ember arrays
 * - seed the arrays with a historical query
 * - open a socket that will append to those arrays
 */

/**
 * What do we need to do with observations?
 * Thro
 */
